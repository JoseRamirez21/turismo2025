...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (empty($errors)) {
        ...
        if ($controller->create($data)) {
            ...
            $errors[] = "No se pudo registrar el count request. Intenta nuevamente.";
        }
    }
}

$pageTitle = "Nuevo Count Request";
    ...
    <main class="col-md-9 col-lg-10 px-md-4 py-4">
      <div class="d-flex justify-content-between align-items-center mb-4 border-bottom pb-2">
        <h2 class="fw-bold text-primary">
          <i class="bi bi-plus-circle-fill me-2"></i> Nuevo Count Request
        </h2>
      ...
      <div class="card shadow-sm border-0 rounded-3">
        <div class="card-body">
          <form method="POST">
            ...
            <!-- Token -->
            <div class="mb-3">
              <label for="id_token" class="form-label fw-semibold">
              ...
              <select name="id_token" id="id_token" class="form-select" required>
                ...
                <?php foreach ($tokens as $t): ?>
                  <option value="<?= $t['id'] ?>" <?= (($_POST['id_token'] ?? '') == $t['id']) ? 'selected' : '' ?>>
            ...
            <div class="mb-3">
              <label for="tipo" class="form-label fw-semibold">
                <i class="bi bi-card-text me-1"></i> Tipo
              </label>
