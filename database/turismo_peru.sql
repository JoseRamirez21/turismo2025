...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 07-11-2025 a las 02:24:10
...
INSERT INTO `admins` (`id_admin`, `nombre`, `email`, `password`, `fecha_creacion`) VALUES
(4, 'Administrador', 'admin@turismo.com', '$2y$10$FDvTsBvXk0lEIEcpzERBy.oLlBrr0TSzrxgqeuInHBzYOrY30qn/i', '2025-09-04 21:10:16');
...
INSERT INTO `client_api` (`id`, `dni`, `nombre`, `apellido`, `telefono`, `correo`, `fecha_registro`, `estado`) VALUES
(1, '76122823', 'Jose Carlos', 'Ramirez', '901267943', 'grhreiungeui@gmail.com', '2025-09-19 14:57:19', 1),
(2, '76543456', 'gdrg', 'grd', '345612', 'grhreiungeui@gmail.com', '2025-09-19 15:13:52', 1);
...
--
-- Volcado de datos para la tabla `count_request`
--

INSERT INTO `count_request` (`id`, `id_token`, `tipo`, `fecha`) VALUES
(1, 10, 'Habilitado', '2025-10-15 22:18:31');
...
(27, 23, NULL, 'Parque Chivay', 'Distrito con restos arqueológicos', 'Histórico', -13.5200000, -74.3200000),
...
(58, 54, NULL, 'Mirador Huancavelica', 'Distrito con historia', 'Cultural', -9.9200000, -76.2300000),
...
(85, 81, NULL, 'Plaza Mayor de Lambayeque', 'Centro histórico de la ciudad', 'Cultural', -12.0464000, -77.0428000),
...
(9, 2, '77790ffa98bfe3f332365ff43afdddf7-2', '2025-10-03 13:50:17', 1),
(10, 1, '3d9745d326c616598a440eca7cd5e6e5-1', '2025-10-03 13:50:22', 1);
...
--
ALTER TABLE `count_request`
  ADD CONSTRAINT `count_request_ibfk_1` FOREIGN KEY (`id_token`) REFERENCES `tokens_api` (`id`) ON DELETE CASCADE;
...
--
ALTER TABLE `tokens_api`
  ADD CONSTRAINT `tokens_api_ibfk_1` FOREIGN KEY (`id_client_api`) REFERENCES `client_api` (`id`) ON DELETE CASCADE;
COMMIT;
